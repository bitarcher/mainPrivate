...
import com.bitarcher.aeFunExamplesShowRoom.resourceManagement.ResourcesInfos.SingleBitmapTextureSetFromResIdsResourceInfo;
...
public class RIBase {
    com.bitarcher.aeFunExamplesShowRoom.drawables.characters.Character character;

    Map<String, SingleBitmapTextureSetFromResIdsResourceInfo> map = new Hashtable<>();


    public RIBase(com.bitarcher.aeFunExamplesShowRoom.drawables.characters.Character character)
    {
