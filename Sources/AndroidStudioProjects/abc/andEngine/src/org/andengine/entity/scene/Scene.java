...
public class Scene extends Entity {
	 ...
	 * {@link org.andengine.entity.shape.IShape#onAreaTouched(TouchEvent, float, float)} or
	 ...
	 * {@link org.andengine.entity.shape.Shape#onAreaTouched(TouchEvent, float, float)} or
	 * {@link IOnAreaTouchListener#onAreaTouched(TouchEvent, ITouchArea, float, float)}
...
//		super.setParent(pEntity);
	...
	public boolean unregisterTouchAreas(final ITouchArea.ITouchAreaMatcher pTouchAreaMatcher) {
