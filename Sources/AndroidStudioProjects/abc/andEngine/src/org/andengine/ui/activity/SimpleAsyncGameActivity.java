...
public abstract class SimpleAsyncGameActivity extends BaseGameActivity {
	...
	@Override
	public void onCreateResources(final IGameInterface.OnCreateResourcesCallback pOnCreateResourcesCallback) {
	...
	@Override
	public void onCreateScene(final IGameInterface.OnCreateSceneCallback pOnCreateSceneCallback) {
		this.runOnUiThread(new Runnable() {
			@Override
			public void run() {
	...
	@Override
	public void onPopulateScene(final Scene pScene, final IGameInterface.OnPopulateSceneCallback pOnPopulateSceneCallback) {
		this.runOnUiThread(new Runnable() {
			@Override
			public void run() {
