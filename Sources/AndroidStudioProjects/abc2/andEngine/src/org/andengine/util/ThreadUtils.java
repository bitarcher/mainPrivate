...
public class ThreadUtils {
	...
	public static void dumpCurrentThreadInfo() {
		ThreadUtils.dumpCurrentThreadInfo(Debug.DebugLevel.DEBUG, Thread.currentThread().getStackTrace()[ThreadUtils.STACKTRACE_CALLER_DEPTH]);
	}

	public static void dumpCurrentThreadInfo(final Debug.DebugLevel pDebugLevel) {
		ThreadUtils.dumpCurrentThreadInfo(pDebugLevel, Thread.currentThread().getStackTrace()[ThreadUtils.STACKTRACE_CALLER_DEPTH]);
	}

	private static void dumpCurrentThreadInfo(final Debug.DebugLevel pDebugLevel, final StackTraceElement pCaller) {
