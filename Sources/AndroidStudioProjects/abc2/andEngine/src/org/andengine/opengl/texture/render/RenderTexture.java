...
public class RenderTexture extends Texture {
	...
	/**
	 * @param pGLState
	 * @throws RenderTextureInitializationException when this {@link RenderTexture} could not be initialized. The {@link org.andengine.opengl.exception.GLException} contains the error code. When this exception is throw, all cleanup will be automatically performed through {@link RenderTexture#destroy(GLState)}.
	 */
