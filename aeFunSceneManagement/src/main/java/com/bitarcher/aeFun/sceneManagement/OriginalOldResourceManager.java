...
public class OriginalOldResourceManager extends Object {
	
	//====================================================
	// CONSTANTS
	//====================================================
	private static final OriginalOldResourceManager INSTANCE = new OriginalOldResourceManager();
	...
	// CONSTRUCTOR
	//====================================================
	private OriginalOldResourceManager(){
	}
	...
	public static OriginalOldResourceManager getInstance(){
		return INSTANCE;
	}
